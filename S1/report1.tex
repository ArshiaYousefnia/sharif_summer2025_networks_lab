...
\begin{document}
	...
	\textenglish{Ethernet, Wi-Fi, PPP}
	 است. در مقایسه با \textenglish{OSI}، ترکیبی از لایه پیوند داده\LTRfootnote{\textenglish{Data Link}} و لایه فیزیکی\LTRfootnote{\textenglish{Physical}} (به ترتیب لایه های دوم و اول) در مدل OSI است. مثال: فریم‌های داده از طریق کابل شبکه یا وای‌فای بین دو دستگاه منتقل می‌شوند.
	\subsection{}
